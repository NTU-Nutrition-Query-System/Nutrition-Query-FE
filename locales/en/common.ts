...
export default {
  ...
  SaveRecord: {
    ...
    saveButton: "save to my history",
    selectDate: "select meal date",
    selectTime: "select meal time",
    selectMealType: "select meal type",
    toastLogin: "please log in first",
    toastSaved: "record saved",
    toastSelectTime: "please select meal time",
    toastSelectMealType: "please select meal type",
    toastError: "failed to save, please try again later",
  },
